...
--
-- Host: localhost:3306
-- Generation Time: Mar 29, 2026 at 09:57 PM
...
CREATE TABLE `attendance_register` (
  ...
  `month_date` varchar(7) COLLATE utf8mb4_general_ci NOT NULL,
  `atten_data` text COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `crime_history` (
  ...
  `ch_name` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cstomer_review` (
  `cr_id` int NOT NULL,
  `review_detail` text COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `gender_master` (
  ...
  `gender_name` varchar(10) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `illness_master` (
  `il_id` int NOT NULL,
  `illness_name` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `language_master` (
  `l_id` int NOT NULL,
  `language_name` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `login` (
  ...
  `profile_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `marital_status_master` (
  ...
  `m_status_name` varchar(10) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `nurses_master` (
  `nr_id` int NOT NULL,
  `nr_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `police_verification` (
  ...
  `pv_name` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `quote_request` (
  ...
  `quote_details` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `created_on` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `read_unread` enum('0','1') COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `service_manager` (
  ...
  `services_photo` text COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `skills_master` (
  `sk_id` int NOT NULL,
  `skill_name` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `stay_type` (
  `st_id` int NOT NULL,
  `st_type_name` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user_details` (
  ...
  `fat_hus_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `email_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `phone_number` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `alt_phone_number` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `curr_address` text COLLATE utf8mb4_general_ci NOT NULL,
  `city_id` int NOT NULL COMMENT 'PK of cities',
  `state_id` int NOT NULL DEFAULT '0' COMMENT 'PK of states table',
  `country_id` int NOT NULL COMMENT 'PK of countries',
  `pincode` varchar(6) COLLATE utf8mb4_general_ci NOT NULL,
  `adhar_card` varchar(12) COLLATE utf8mb4_general_ci NOT NULL,
  `adhar_card_img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `adhar_card_back_img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `pan_card` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `pan_card_img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `voter_id_card` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `voter_id_card_img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `voter_id_card_back_img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `user_photo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `wt_id` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'PK of work_type',
  `work_exp` int NOT NULL DEFAULT '0',
  `earlier_work_city` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `last_emplr_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `sk_id` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'PK of skills_master',
  `l_id` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'PK of language_master',
  `work_loc` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `st_id` int NOT NULL DEFAULT '0' COMMENT 'PK of stay_type',
  ...
  `il_id` int NOT NULL DEFAULT '0' COMMENT 'PK of illness_master',
  ...
  `emg_cont_person` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `relation` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `emg_cont_number` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `bank_details` text COLLATE utf8mb4_general_ci NOT NULL,
  `bank_details_img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `highest_edu` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `declaration` tinyint(1) NOT NULL DEFAULT '0',
  `lc_id` tinyint NOT NULL DEFAULT '0',
  `wh_id` int NOT NULL COMMENT '	PK of working_hour_master',
  `religion` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `nationality` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `family_bg_info` text COLLATE utf8mb4_general_ci NOT NULL,
  `nr_id` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'PK of nurses_master',
...
(37, '', '', 5, 1, 'Jhuma Pal', 'Nitya Kumar Sutradhar', '', '9242835162', '', 2, '1990-08-05', 2, 'Balgana Station para balgana Tulshidanga Barddhaman West Bengal', 'Balgana Station para balgana Tulshidanga Barddhaman West Bengal', 588, 24, 105, '713125', '969930864527', '1774683942.jpeg', '1774683947.jpeg', '', '', '', '', '', '1774683951.jpeg', '1', 4, '', '', '[\"2\",\"1\"]', '[\"1\"]', '', 0, 0.00, '2026-03-15 17:10:18', 0, 0, 0, 0, '', '', '', '', '', '4th passed', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-15 17:10:18', '2026-03-28 13:15:51'),
...
(119, '', '', 5, 1, 'Tusi Das', 'Sudip Das', '', '7890753803', '6291231601', 2, '1980-05-15', 2, '56/2/A/2, Satkari Chatterjee Lane Haora Corporation PO Haora', '', 592, 24, 105, '711101', '9135 0597 13', '1774357080.jpeg', '1774357085.jpeg', '', '', '', '', '', '1774357090.jpeg', '', 9, '', '', '[\"7\",\"2\",\"1\"]', '[\"1\"]', '', 1, 13000.00, '2026-03-24 18:19:02', 0, 2, 1, 0, '', '', '', '', '', '', 1, 0, 0, '', '', '', '', 1, 1, '2026-03-24 18:19:02', '2026-03-28 09:18:25'),
...
(161, '', '', 5, 1, 'Tapati Biswas', 'Tapan Biswas', '', '9242193769', '7001485988', 2, '2005-07-07', 2, 'Toherpur Natunpara Birnagar Nadia', '', 599, 24, 105, '741127', '343444586909', '1774678949.jpeg', '1774678953.jpeg', '', '', '', '', '', '1774678958.jpeg', '3', 3, '', '', '[\"3\"]', '[\"1\",\"3\"]', '', 1, 0.00, '2026-03-27 19:00:59', 0, 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-27 19:00:59', '2026-03-28 11:54:20'),
(162, '', '', 5, 1, 'Sabita Biswas', 'Dev Rajan Biswas', '', '9339804546', '', 2, '1983-01-01', 2, 'Nabarupdaha Ghugrahaghachi Bayandeng Nadia West Bengal ', '', 599, 24, 105, '', '847725622489', '1774679783.jpeg', '1774679787.jpeg', '', '', '', '', '', '1774679792.jpeg', '4', 8, '', '', '[\"7\",\"4\"]', '[\"1\",\"3\"]', '', 1, 0.00, '2026-03-28 12:02:16', 0, 0, 0, 0, '', '', '', '', '', '9th passed', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 12:02:16', '2026-03-28 12:07:20'),
(163, '', '', 5, 1, 'Anjana Ray', 'Atul Biswas ', '', '6296478594', '', 2, '1981-01-01', 2, 'Charmandal Charmandal Bhag Naldugri North 24pgs West Bengal', '', 600, 24, 105, '743297', '225083841254', '1774680319.jpeg', '1774680332.jpeg', '', '', '', '', '', '1774680333.jpeg', '1', 6, '', '', '[\"2\",\"1\"]', '', '', 1, 0.00, '2026-03-28 12:11:21', 0, 0, 0, 0, '', '', '', '', '', '8TH PASSED', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 12:11:21', '2026-03-28 12:16:25'),
(164, '', '', 5, 1, 'Rubi Chowdhury ', 'Rajkumar Chowdhury ', '', '8100408960', '', 2, '1972-01-01', 2, 'Chengail Ayama Para Chengail Howrah  West Bengal', '', 592, 24, 105, '711308', '233092441230', '1774681622.jpeg', '1774681638.jpeg', '', '', '', '', '', '1774681526.jpeg', '3', 10, '', '', '[\"3\"]', '[\"1\",\"3\"]', '', 2, 0.00, '2026-03-28 12:18:59', 0, 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 12:18:59', '2026-03-28 12:38:19'),
(165, '', '', 5, 1, 'Arpita Haldar', 'Biswanath Haldar', '', '9875488319', '', 2, '1985-07-18', 2, '67/8 Dharmatala Road Salkia Hoara Howrah West Bengal', '', 592, 24, 105, '711106', '273105760312', '1774682601.jpeg', '1774682605.jpeg', '', '', '', '', '1774682615.jpeg', '1774682620.jpeg', '5', 4, '', '', '[\"3\"]', '[\"1\",\"3\"]', '', 2, 0.00, '2026-03-28 12:47:41', 0, 0, 0, 0, '', '', '', '', '', '6TH PASSED', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 12:47:41', '2026-03-28 12:54:18'),
...
(167, '', '', 5, 1, 'Kakali Bag', 'Nityananda Bag', '', '9043864361', '8942048591', 2, '1992-07-05', 2, 'Panpur Serpur Howrah West Bengal Amta 1', '', 592, 24, 105, '711401', '263466828715', '1774684576.jpeg', '1774684582.jpeg', '', '', '', '', '', '1774684640.jpeg', '1', 3, '', '', '[\"2\",\"1\"]', '[\"1\"]', '', 0, 0.00, '2026-03-28 13:22:53', 0, 0, 0, 0, '', '', '', '', '', '5th passed', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 13:22:53', '2026-03-28 13:28:32'),
(168, '', '', 5, 0, 'Ganesh  K C', 'Khadak Bahadur Khatri', '', '9831974887', '', 2, '1984-09-15', 1, '42/1/H/4 Ekbalpore Lane Near Ghazi club khiddirpore kolkata', '', 0, 24, 105, '', '627681319663', '1774688996.jpeg', '1774689002.jpeg', '', '', '', '', '', '1774689006.jpeg', '2', 10, '', '', '[\"2\"]', '[\"3\"]', '', 1, 0.00, '2026-03-28 14:34:30', 0, 0, 0, 0, '', '', '', '', '', '4th passed', 0, 0, 0, '', '', '', '', 0, 0, '2026-03-28 14:34:30', '2026-03-28 14:41:41'),
(169, '', '', 5, 1, 'ki', '', '', '', '', 1, '0000-00-00', 1, '', '', 0, 0, 0, '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', '', 0, 0.00, '2026-03-28 14:42:59', 0, 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', '', '', 1, 0, '2026-03-28 14:42:59', '2026-03-28 14:42:59'),
(170, '', '', 5, 1, 'Kainatun Nesha', 'Md. Shamim', '', '9330430884', '8100051287', 2, '1987-04-20', 2, '127 Noor Mohammad Munshi Lane Haora Howrah West Bengal', '', 592, 24, 105, '711101', '579700213790', '1774689825.jpeg', '1774689829.jpeg', 'AJWPN7974P', '1774689835.jpeg', '', '', '', '1774689842.jpeg', '1', 4, '', '', '[\"1\"]', '[\"3\"]', '', 1, 0.00, '2026-03-28 14:43:55', 0, 0, 0, 0, '', '', '', '', '', '10TH PASSED', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 14:43:55', '2026-03-28 14:56:52'),
(171, '', '', 5, 1, 'Shaida Bibi', 'Nasim Khan', '', '8274969677', '', 2, '1995-01-01', 2, 'New Panchur Molla Para Rabindranagar Maheshtala Bidhangarh', '', 601, 24, 105, '700066', '668785242783', '1774691009.jpeg', '', '', '', '', '', '', '1774691014.jpeg', '2', 3, '', '', '[\"2\",\"1\"]', '[\"3\"]', '', 2, 0.00, '2026-03-28 15:06:34', 0, 0, 0, 0, '', '', '', '', '', '10TH PASSED', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 15:06:34', '2026-03-28 15:15:32'),
(172, '', '', 5, 1, 'Soumitra Kumar Ghosh', 'Tapan Kumar Ghosh', '', '8670148340', '', 2, '1986-01-14', 2, 'Barbarisha Bara Barisha Purba Medinipur', '', 597, 24, 105, '721134', '304198669194', '1774691784.jpeg', '1774691789.jpeg', 'AZOPG3565D', '1774691805.jpeg', '', '', '', '', '1', 4, '', '', '[\"1\"]', '[\"1\",\"3\"]', '', 1, 0.00, '2026-03-28 15:19:15', 0, 0, 0, 0, '', '', '', '', '', '12TH PASSED', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28
"]', '[\"1\",\"3\"]', '', 1, 0.00, '2026-03-28 18:06:45', 0, 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 18:06:45', '2026-03-28 18:12:18'),
(198, '', '', 5, 1, '', 'Panchanan Samanta', '', '', '', 1, '0000-00-00', 1, '', '', 0, 0, 0, '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', '', 0, 0.00, '2026-03-28 18:06:55', 0, 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', '', '', 1, 0, '2026-03-28 18:06:55', '2026-03-28 18:06:55'),
...
(201, '', '', 5, 1, 'Alka Bharti ', 'Shyam Babu Bharti', '', '7439939139', '', 2, '2006-01-31', 2, 'Budge Budge 1 South 24Pgs ', '', 601, 24, 105, '743318', '823561348681', '1774703461.jpeg', '', '', '', '', '', '', '1774703466.jpeg', '1', 2, '', '', '[\"1\"]', '[\"3\"]', '', 1, 0.00, '2026-03-28 18:36:42', 0, 0, 0, 0, '', '', '', '', '', '12th passed', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 18:36:42', '2026-03-28 18:41:48'),
(202, '', '', 5, 1, 'Shankari Sahani', 'Shankar Sahani ', '', '9088251604', '', 2, '1990-01-01', 2, 'Bauria Bhasapara Howrah West Bengal ', '', 592, 24, 105, '711305', '758495887520', '1774703818.jpeg', '1774703821.jpeg', '', '', '', '', '', '1774703835.jpeg', '5', 18, '', '', '[\"5\"]', '[\"1\",\"3\"]', '', 1, 0.00, '2026-03-28 18:44:16', 0, 0, 0, 0, '', '', '', '', '', '4th passed', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 18:44:16', '2026-03-28 18:48:01'),
(203, '', '', 5, 1, 'Purbasa Das', 'Abhijit Das', '', '', '', 2, '2008-06-25', 1, 'Bhagabanpur Mollahal Shyampur 1 Howrah West Bengal', '', 592, 24, 105, '711314', '326063008755', '', '', '', '', '', '', '', '', '3', 0, '', '', '[\"1\"]', '[\"1\"]', '', 0, 0.00, '2026-03-28 18:49:38', 0, 0, 0, 0, '', '', '', '', '', '8th passed', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 18:49:38', '2026-03-28 18:54:24'),
(204, '', '', 5, 1, 'Rupa Bhattacharya ', 'Ganesh Prasad Srivastab', '', '9038296094', '', 1, '1972-09-04', 2, 'A.K Mukherjee Road Baranagar North 24 pgs ', '', 600, 24, 105, '711310', '', '', '', '', '', '', '', '', '', '4', 10, '', '', '[\"3\"]', '[\"1\"]', '', 1, 0.00, '2026-03-28 18:55:52', 0, 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', '', '', 1, 1, '2026-03-28 18:55:52', '2026-03-28 18:58:53'),
...
CREATE TABLE `weekly_off` (
  ...
  `wf_name` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `working_hour_master` (
  `wh_id` int NOT NULL,
  `wh_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `attendance_register`
  MODIFY `atten_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `cstomer_review`
  MODIFY `cr_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `illness_master`
  MODIFY `il_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `language_master`
--
ALTER TABLE `language_master`
  MODIFY `l_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `nurses_master`
  MODIFY `nr_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `quote_request`
  MODIFY `quote_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `skills_master`
  MODIFY `sk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `stay_type`
  MODIFY `st_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `user_details`
--
ALTER TABLE `user_details`
  MODIFY `user_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
...
--
ALTER TABLE `working_hour_master`
  MODIFY `wh_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `work_type`
--
ALTER TABLE `work_type`
  MODIFY `wt_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
